...
use std::os::fd::RawFd;
use libc::{ifreq, ioctl, sendto, sockaddr, socket};
use crate::{Ifreq, DEST_MAC, ETHERTYPE_IPV4, AF_INET, AF_PACKET, ETH_P_ALL, SIOCGIFHWADDR, SOCK_DGRAM, SOCK_RAW, SIOCGIFADDR, sockaddr_ll};
